...
const FilterButton = ({ searchKeyword, filterExpand, setFilterExpand }) => {
  return (
    ...
    >
      ...
      <div
        className={`${filterExpand ? "flex" : "hidden"} flex-col justify-center items-center w-full  shadow-inner border-[#00000020] absolute top-full left-0 bg-(--colorWarmGray) z-10 rounded-b-2xl text-black overflow-hidden [&>div]:w-full [&>div]:text-center [&>div]:hover:bg-(--colorBlue) [&>div]:py-2 [&>div]:border-t-[#00000020] [&>div]:border-t-2 [&>div]:hover:text-(--colorWarmGray) [&>div]:transition [&>div]:duration-300`}
      >
